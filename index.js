...
${frame.code}`;
    ...
    `;
        ...
        var _typewriterEffect = require("./scripts/typewriterEffect");
        ...
        (0, _typewriterEffect.typeWriter)();

    }, { "./scripts/scrollReveal": "1YCUQ", "./scripts/tiltAnimation": "4qDox", "./scripts/typewriterEffect": "alTFA", "./data/scrollRevealConfig": "aeHJJ", "@parcel/transformer-js/src/esmodule-helpers.js": "jnFvT" }], "1YCUQ": [function (require, module, exports, __globalThis) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
 ...
 */ var VanillaTilt = function () {
   ...
   */ VanillaTilt.init(document.querySelectorAll("[data-tilt]"));
    ...
    }, {}], "alTFA": [function (require, module, exports, __globalThis) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        parcelHelpers.export(exports, "typeWriter", () => typeWriter);
        const subTitles = [
            "Full stack software developer",
            "Possibly your next best hire",
            "Delivering solutions from the Himalayas"
        ];
        let subTitleIndex = 0;
        let i = 0;
        let reverse = false;
        function typeWriter(containerId = "subtitle-container") {
            const textJitter = Math.floor(Math.random() * 25 + 45);
            let currentText = subTitles[subTitleIndex];
            if (reverse) handleTextRemoval(containerId, textJitter);
            else handleTextTyping(containerId, currentText, textJitter);
        }
        function handleTextRemoval(containerId, textJitter) {
            ...
            } else moveToNextSubtitle(containerId);
        }
        ...
        const initProjectModal = () => {
            ...
            projectItems.forEach(item => {
                item.addEventListener('click', (e) => {
                    // Prevent default link behavior if clicking the link wrapper directly
...
}, ["5j6Kf", "a0t4e"], "a0t4e", "parcelRequiree89c", {})
